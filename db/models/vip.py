...
from sqlalchemy import null, null, ForeignKey, ForeignKey, DateTime, String, func
...
class Vip(Base):
    ...
    expire_date:Mapped[datetime.datetime] = mapped_column(DateTime(timezone=True),nullable=True)
